                                ...
                                <div id="button-trigger" class="card card card-default scrollspy">
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="{{url('/customer/lodgment/'.$customer->id)}}" class="btn cyan waves-effect waves-light green darken-1 right"> Add new customer payment/lodgement</a>
                                            </div>
                                            <div class="col s12">
                                            ...
                                            <thead>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                      <td>
                                                        <a href="{{url('/prf/payment-history/'.$payment->order_id)}}">{{$payment->id}}</a>
                                                      </td>
