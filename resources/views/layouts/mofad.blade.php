...
<body
    ...
    @section('side_nav')
        <aside
            ...
            <div class="brand-sidebar">
                <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{ url('/home') }}"><img
                            class="hide-on-med-and-down " src="{{ asset('app-assets/images/logo/materialize-logo.p') }}ng"
    ...
    <div id="main">
        <div class="row">
            <div class="pt-3 pb-1 breadcrumbs-bg-image" id="breadcrumbs-wrapper"
                data-image="/app-assets/images/gallery/breadcrumb-bg2.jpg"
                style="background-image: url(/app-assets/images/gallery/breadcrumb-bg2.jpg);">
                        ...
                        <div class="section">
                            <div class="row user-profile mt-1 ml-0 mr-0">
                                <img class="responsive-img" alt=""
                                    src="{{ asset('app-assets/images/gallery/profile-bg.png') }}">
                            </div>
                                            ...
                                            <ul class="widget-timeline mb-0">
                                                ...
                                                <li class="timeline-items timeline-icon-red active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <img src="{{ asset('') }}app-assets/images/icon/pdf.png"
    ...
    <footer class="page-footer footer footer-static footer-light navbar-border navbar-shadow">
        @section('footer')
            <div class="footer-copyright">
                <div class="container"><span>&copy; 2020 <a href="www.rightcliclsolutions.com"
                            target="_blank">RightClick </a> All rights reserved.</span><span
                        class="right hide-on-small-only"> <a href="">MOFAD</a></span></div>
            </div>
        @show
    </footer>
